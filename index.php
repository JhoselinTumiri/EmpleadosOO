...
$empleadoPC = new EmpleadoPorComision("Maria", "Behobide", "18-56895478-56",5,30,10);

//llamada al método mostrar
$resultado = "<b>Empleado:</b></br></br> ";
$resultado .= "<p><b>Empleado Asalariado:</b></br> ".$empleado1->mostrar()."</br>Los ingresos son: ".$empleado1->ingresos()."</p></br>";

$resultado .= "<p><b>Empleado Por Comisión:</b></br> ".$empleadoPC->mostrar()."</br>Los ingresos son: ".$empleadoPC->ingresos()."</br>";
...
$resultado .= "<p><b>La suma total de ingresos es: </b></br> ". $empresa->sumaIngresos() ."</br>";
